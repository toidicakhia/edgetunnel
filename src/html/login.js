	...
	<style>
		* {
		...
		body::before {
			...
			z-index: 0;
			background:
				radial-gradient(ellipse 70% 50% at 30% 20%, rgba(246, 130, 31, 0.1), transparent 60%),
				radial-gradient(ellipse 50% 40% at 80% 80%, rgba(59, 130, 246, 0.06), transparent 60%);
		}
		...
		@keyframes glow {
			...
			50% {
				box-shadow: 0 0 35px rgba(246, 130, 31, 0.35);
			}
		}
		...
		.card::before {
			...
			background: linear-gradient(90deg, #f6821f, #ff9436, #f6821f);
		...
		.logo {
			...
			margin: 0 auto 24px;
			border-radius: 16px;
			background: linear-gradient(135deg, #f6821f, #e05a00);
			display: grid;
			place-items: center;
		...
		.btn {
			...
			background: linear-gradient(135deg, #f6821f, #d96f00);
			color: #fff;
			box-shadow: 0 4px 16px rgba(246, 130, 31, 0.3);
		}

		.btn:hover {
			box-shadow: 0 6px 24px rgba(246, 130, 31, 0.45);
