	...
	<style>
		* {
		...
		body::before {
			...
			z-index: -1;
			background:
				radial-gradient(ellipse 80% 60% at 10% 20%, rgba(246, 130, 31, 0.07), transparent 60%),
				radial-gradient(ellipse 60% 50% at 90% 80%, rgba(59, 130, 246, 0.05), transparent 60%);
		}
		...
		.btn-accent {
			...
			color: #fff;
			box-shadow: 0 2px 12px rgba(246, 130, 31, 0.25);
		}
...
<body>
			...
			<div class="content">
				...
				<div class="panel active" id="panel-overview">
					<div class="stats" id="statsGrid">
						<div class="stat">
							...
							<div class="stat-val" id="s-proto"><div class="skeleton" style="width:60px;height:18px"></div></div>
						</div>
						<div class="stat">
							<div class="stat-label">Transport</div>
							<div class="stat-val" id="s-transport"><div class="skeleton" style="width:80px;height:18px"></div></div>
						</div>
						<div class="stat">
							<div class="stat-label">CF Requests Today</div>
							<div class="stat-val" id="s-cf"><div class="skeleton" style="width:100px;height:18px"></div></div>
						</div>
						<div class="stat">
							<div class="stat-label">Config Loaded</div>
							<div class="stat-val" id="s-time"><div class="skeleton" style="width:50px;height:18px"></div></div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-head">
							<div>
								...
								<div class="card-desc">Generated from your active protocol settings</div>
							</div>
					...
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Subscription URLs</div>
								<div class="card-desc">Import into Clash, SingBox, Shadowrocket or V2Ray</div>
							</div>
						</div>
						<div class="form-grid">
							<div class="field">
								...
								<div class="link-box">
									<div class="link-text" id="subAuto">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subAuto').textContent)">Copy</button>
								</div>
							</div>
							<div class="field">
								<label>Clash / Meta</label>
								<div class="link-box">
									<div class="link-text" id="subClash">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subClash').textContent)">Copy</button>
								</div>
							</div>
							<div class="field">
								<label>Sing-Box</label>
								<div class="link-box">
									<div class="link-text" id="subSingbox">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subSingbox').textContent)">Copy</button>
								</div>
							</div>
							<div class="field">
								<label>Base64</label>
								<div class="link-box">
									<div class="link-text" id="subB64">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subB64').textContent)">Copy</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel" id="panel-links">
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Connection Link</div>
								<div class="card-desc">Copy this link into your client app</div>
							</div>
						</div>
						<div class="link-box">
							<div class="link-text" id="nodeLink2">-</div>
							<button class="btn btn-accent btn-sm" onclick="copy(document.getElementById('nodeLink2').textContent)">Copy</button>
						</div>
					</div>
					<div class="card">
						<div class="card-head">
							<div><div class="card-title">All Subscription URLs</div></div>
						</div>
						<div class="form-grid">
							<div class="field">
								<label>Universal</label>
								<div class="link-box">
									<div class="link-text" id="subAuto2">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subAuto2').textContent)">Copy</button>
								</div>
							</div>
							<div class="field">
								<label>Clash / Meta</label>
								<div class="link-box">
									<div class="link-text" id="subClash2">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subClash2').textContent)">Copy</button>
								</div>
							</div>
							<div class="field">
								<label>Sing-Box</label>
								<div class="link-box">
									<div class="link-text" id="subSingbox2">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subSingbox2').textContent)">Copy</button>
								</div>
							</div>
							<div class="field">
								<label>Base64</label>
								<div class="link-box">
									<div class="link-text" id="subB642">-</div>
									<button class="btn btn-ghost btn-sm" onclick="copy(document.getElementById('subB642').textContent)">Copy</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel" id="panel-protocol">
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Core Protocol</div>
								<div class="card-desc">Tunneling protocol, transport layer, and TLS parameters</div>
							</div>
						</div>
						<div class="form-grid">
							<div class="field">
								<label>Protocol Type (Subscription)</label>
								...
								<p class="field-hint">Controls which protocol links appear in subscription output. All protocols are always accepted at the transport level.</p>
							</div>
							<div class="field">
							...
							<div class="field">
								...
								<input type="text" id="cfg-path" placeholder="/">
							</div>
							<div class="field">
						...
						<div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem">
							<div class="toggle-row">
								<div class="toggle-info">
									<div class="t-title">Skip Certificate Verify</div>
									<div class="t-desc">Allow insecure TLS connections</div>
								</div>
								<label class="switch"><input type="checkbox" id="cfg-skipCertVerify"><span class="slider"></span></label>
							</div>
							<div class="toggle-row">
								<div class="toggle-info">
									<div class="t-title">0-RTT Early Data</div>
									<div class="t-desc">Zero Round Trip Time acceleration</div>
								</div>
								<label class="switch"><input type="checkbox" id="cfg-enable0RTT"><span class="slider"></span></label>
							</div>
							<div class="toggle-row">
								<div class="toggle-info">
									<div class="t-title">Random Path</div>
									<div class="t-desc">Randomized path prefixes for obfuscation</div>
								</div>
								<label class="switch"><input type="checkbox" id="cfg-randomPath"><span class="slider"></span></label>
							</div>
							<div class="toggle-row">
								<div class="toggle-info">
									<div class="t-title">ECH (Encrypted Client Hello)</div>
									<div class="t-desc">SNI obfuscation via DoH</div>
								</div>
								<label class="switch"><input type="checkbox" id="cfg-ech" onchange="toggleECH()"><span class="slider"></span></label>
							</div>
						</div>
						<div id="echConfig" style="display:none;margin-top:.75rem">
							<div class="form-grid">
								<div class="field">
									<label>ECH DoH DNS</label>
									<input type="text" id="cfg-echDns" placeholder="https://dns.alidns.com/dns-query">
								</div>
								<div class="field">
									<label>ECH SNI</label>
									<input type="text" id="cfg-echSni" placeholder="cloudflare-ech.com">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Shadowsocks Settings</div>
								<div class="card-desc">AEAD cipher and TLS transport for SS protocol</div>
							</div>
						</div>
						<div class="form-grid">
							<div class="field">
							...
							<div class="toggle-row">
								<div class="toggle-info">
									<div class="t-title">Use TLS for SS</div>
									<div class="t-desc">Send SS over wss:// instead of ws://</div>
								</div>
								<label class="switch"><input type="checkbox" id="cfg-ssTls"><span class="slider"></span></label>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel" id="panel-subscriptions">
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Subscription Generator</div>
								<div class="card-desc">Configure optimal IP pools and auto-update</div>
							</div>
						</div>
						<div class="form-grid">
							<div class="field">
								<label>Subscription Name</label>
								<input type="text" id="cfg-subname" placeholder="edgetunnel">
							</div>
							<div class="field">
								<label>Specified Port (-1 = all)</label>
								<input type="number" id="cfg-specifiedPort" value="-1">
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Custom IP List (ADD.txt)</div>
								<div class="card-desc">IP:PORT or domain nodes to inject</div>
							</div>
							<button class="btn btn-ghost btn-sm" onclick="saveAddTxt()">Save ADD.txt</button>
						</div>
				...
				<div class="panel" id="panel-cloudflare">
					<div class="card">
						<div class="card-head">
							<div>
								<div class="card-title">Cloudflare Credentials</div>
								<div class="card-desc">Monitor Workers &amp; Pages daily quota</div>
							</div>
						</div>
						<div class="form-grid">
							<div class="field">
								<label>Account Email</label>
								<input type="email" id="cfg-cfEmail" placeholder="user@example.com">
							</div>
							<div class="field">
								<label>Global API Key</label>
								<input type="password" id="cfg-cfApiKey" placeholder="API Key">
							</div>
							<div class="field">
								<label>Account ID</label>
								<input type="text" id="cfg-cfAccountId" placeholder="Account ID">
							</div>
							<div class="field">
								<label>API Token (optional)</label>
								<input type="password" id="cfg-cfApiToken" placeholder="API Token">
							</div>
						</div>
						<div style="display:flex;justify-content:flex-end;margin-top:.5rem">
							<button class="btn btn-ghost" onclick="saveCfSettings()">Save Cloudflare</button>
						</div>
					</div>
					...
					<div class="card danger-zone">
						<div class="card-head">
							<div>
								...
								<div class="card-desc">Restore all settings to defaults</div>
							</div>
							<button class="btn btn-danger btn-sm" onclick="resetDefaults()">Reset All</button>
						</div>
					</div>
				</div>
	...
	<div class="modal-bg" id="qrModal" onclick="if(event.target===this)closeQr()">
		<div class="modal">
			<div class="modal-head">
				...
				<button class="modal-x" onclick="closeQr()">&times;</button>
			</div>
	...
	<script>
		...
		function toggleECH() {
			const e = document.getElementById('cfg-ech').checked;
			document.getElementById('echConfig').style.display = e ? '' : 'none';
		}
		...
		async function saveAll() {
			try {
				...
				C.ECHConfig = {
					DNS: document.getElementById('cfg-echDns').value || 'https://dns.alidns.com/dns-query',
					SNI: document.getElementById('cfg-echSni').value || 'cloudflare-ech.com',
				};
				C.SS = {
		...
		async function loadAddTxt() {
			try {
				...
				if (r.ok) {
					...
					document.getElementById('cfg-addTxt').value = t === 'null' ? '' : t;
				}
			} catch (e) {}
		}
		...
		async function saveAddTxt() {
			try {
				const r = await fetch('/admin/ADD.txt', {
					...
					body: document.getElementById('cfg-addTxt').value,
				});
				r.ok ? showToast('ADD.txt saved!') : showToast('Save failed', 'err');
			} catch (e) {
		...
		async function saveCfSettings() {
			try {
				const r = await fetch('/admin/cf.json', {
					method: 'POST',
					headers: { 'Content-Type': 'application/json' },
					body: JSON.stringify({
				...
				r.ok ? showToast('Cloudflare saved!') : showToast('Save failed', 'err');
			} catch (e) {
				showToast(e.message, 'err');
			}
		}
